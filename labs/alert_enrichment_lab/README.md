...
Fetch latest sales via the dedicated GitHub Actions latest-sales worker:
...
- `--github-live` routes the latest-sales fetch through the dedicated latest-sales worker repo.
